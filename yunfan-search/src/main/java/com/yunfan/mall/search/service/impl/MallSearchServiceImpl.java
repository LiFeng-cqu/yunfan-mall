...
import com.yunfan.mall.search.vo.AttrResponseVo;
import com.yunfan.mall.search.vo.SearchParam;
import com.yunfan.mall.search.vo.SearchResult;
import com.yunfan.mall.search.feign.ProductFeignService;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse response = esRestClient.search(searchRequest, YunfanElasticSearchConfig.COMMON_OPTIONS);
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("http://search.yunfan.com/list.html?" + replace);
