package com.yunfan.mall.product.exception;
...
@RestControllerAdvice(basePackages = "com.yunfan.mall.product.controller")
public class YunfanExceptionControllerAdvice {
